    ...
    <div className="bg-gray-900 min-h-screen py-6">
      <div className="container mx-auto pt-24 px-4 md:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-4">
          <div className="bg-white flex items-center pl-4 pr-2 overflow-hidden mb-4 md:mb-0 w-full md:w-auto">
            <FaSearch />
            <input
              type="search"
              ...
              className="p-2 outline-none border-none placeholder:text-black w-full md:w-auto"
            />
          </div>
          ...
          <button
            ...
            className="hidden lg:block py-2 px-4 bg-white w-full md:w-auto"
          >
        ...
        >
          {sortedCamps.map((camp) => (
            <div
              key={camp._id}
              className="bg-green-500 p-4 rounded shadow-lg flex flex-col justify-between"
            >
              <img
              ...
              <Link
                to={`/camps/${camp._id}`}
                className="bg-black text-white/90 px-3 py-2 rounded text-center"
              >
                Details
              </Link>
            </div>
